...
import { Button } from '@mise/ui'
import { IconButton } from '@mise/ui'
import { Pill } from '@mise/ui'
import { Input } from '@mise/ui'
import { Textarea } from '@mise/ui'
import { Switch } from '@mise/ui'
import { Card, CardHeader, CardTitle, CardDescription, CardContent } from '@mise/ui'
import { Sheet } from '@mise/ui'
import { Drawer } from '@mise/ui'
import { DropdownMenu } from '@mise/ui'
import { ToastProvider, useToast } from '@mise/ui'
    ...
    <ToastProvider>
      <div className="min-h-screen bg-paper">
        ...
        <div className="sticky top-0 z-10 bg-paper border-b border-paper-3 px-8 py-4 flex items-center justify-between">
          <div>
            <h1 className="font-display text-h2 text-ink font-optical">Mise — design tokens</h1>
            <p className="text-body-sm text-ink-6">Visual QA for Phase 1</p>
          </div>
          <img src="/assets/logo-wordmark.svg" alt="Mise" className="h-7" onError={e => { (e.target as HTMLImageElement).style.display = 'none' }} />
        </div>
