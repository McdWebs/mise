  ...
  return (
    <div className="relative min-h-dvh bg-paper" style={BG}>
      ...
      <button
        ...
        className="fixed bottom-[72px] z-[7] border-2 border-ink w-[52px] h-[52px] rounded-full bg-paper text-ink flex items-center justify-center shadow-1 hover:bg-paper-2 transition-colors duration-hover disabled:opacity-60"
      ...
      <button
        ...
        className="fixed bottom-[72px] z-[7] border-2 border-paper w-[52px] h-[52px] rounded-full bg-ink text-paper flex items-center justify-center shadow-1 hover:bg-ink-2 transition-colors duration-hover"
